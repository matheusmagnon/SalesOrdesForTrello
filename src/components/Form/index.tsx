                    ...
                    >
                      <div>
                        ...
                        <div className="flex-col items-center justify-center">
                          ...
                          <p className="text-baseInput text-center">
                            massa fofinha e aveludada de tom vermelho,
                    ...
                    >
                      <div>
                        ...
                        <div className="flex-col items-center justify-center">
                          ...
                          <p className="text-baseInput text-center">
                            massa amanteigada de baunilha e recheio de
              ...
              /> */}
                ...
                <div className="xl:w-72">
                  ...
                  <input
                    ...
                    {...reactHookFormMethods.register("phraseOnTheCake")}
                    // autoFocus
                    className="bg-baseInput  border border-baseButton  text-baseText placeholder-baseLabel text-base xl:text-sm rounded-lg
                   focus:ring-yellow-300 focus:border-yellow-300 block w-full p-2 "
                  />
              ...
              /> */}
                ...
                <div className="xl:w-64">
                  ...
                  <input
                    ...
                    {...reactHookFormMethods.register("drawingOnTheCake")}
                    // autoFocus
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    {...reactHookFormMethods.register("orderObservation")}
                    // autoFocus
                    className="bg-baseInput  border border-baseButton  text-baseText placeholder-baseLabel text-base xl:text-sm rounded-lg
                   focus:ring-yellow-300 focus:border-yellow-300 block w-full p-2"
                  />
                ...
                <div className="xl:w-36">
                  <label className="bg-fuchsia-950 p-2 text-white block rounded-xl cursor-pointer text-center duration-75">
                    ...
                    <input
                      ...
                      accept="image/*"
                      // name="filesInOrder"
                      {...reactHookFormMethods.register("filesInOrder", {
                        onChange: (e) => {
                          getImagesToUpload(e);
                        },
                      })}
                  ...
                  /> */}
                    <li>
                      <input
                        ...
                        className="hidden peer"
                        id="Sim"
                        {...reactHookFormMethods.register("candleInOrder")}
                      />
